const CACHE='sahinh-ai-pwa-full-v2';
const ASSETS=['./','./index.html','./app.css','./app.js','./apriltag-adapter.js','./manifest.json','./gas-config.js','./icons/icon-192.png','./icons/icon-512.png','./config/tag-map.json','./config/thoi_gian.json','./config/luot_thkc.json'];
