const CACHE='sahinh-ai-pwa-v1.1.7-b01-mp3-only';
const ASSETS=['./','./index.html','./app.css','./app.js','./apriltag-adapter.js','./manifest.json','./gas-config.js','./icon-192.png','./icon-512.png','./audio/b01/doilenh.mp3','./audio/b01/baobai.mp3','./audio/b01/batdau.mp3','./audio/b01/qua30s.mp3'];
